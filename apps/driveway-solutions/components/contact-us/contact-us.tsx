import { CornerGraphic } from './corner-graphic';
        ...
        <div className="-mx-4 flex flex-wrap lg:justify-between">
          <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
            <div className="mb-12 max-w-[570px] lg:mb-0">
              <span className="text-brand-700 mb-4 block text-base font-semibold">Contact Us</span>
              ...
              <div className="mb-8 flex w-full max-w-[370px]">
                <div className="bg-brand-700 text-brand-700 mr-6 flex h-[60px] w-full max-w-[60px] items-center justify-center overflow-hidden rounded bg-opacity-5 sm:h-[70px] sm:max-w-[70px]">
              ...
              <div className="mb-8 flex w-full max-w-[370px]">
                ...
                <div className="w-full">
                  ...
                  <p className="text-base leading-relaxed text-gray-500">(+62)81 414 257 9980</p>
                </div>
              </div>
              <div className="mb-8 flex w-full max-w-[370px]">
                <div className="bg-brand-700 text-brand-700 mr-6 flex h-[60px] w-full max-w-[60px] items-center justify-center overflow-hidden rounded bg-opacity-5 sm:h-[70px] sm:max-w-[70px]">
                ...
                <div className="w-full">
                  ...
                  <p className="text-base leading-relaxed text-gray-500">info@yourdomain.com</p>
                </div>
              </div>
            </div>
          </div>
              ...
              <form>
                <div className="mb-6">
                  <input
                    ...
                    className="text-body-color focus:border-brand-700 w-full rounded border border-[f0f0f0] py-3 px-[14px] text-base outline-none focus-visible:shadow-none"
                  />
                </div>
                <div className="mb-6">
                  <input
                ...
                <div className="mb-6">
                  <textarea
                    ...
                    className="text-body-color focus:border-brand-700 w-full resize-none rounded border border-[f0f0f0] py-3 px-[14px] text-base outline-none focus-visible:shadow-none"
                  ></textarea>
                </div>
                <div>
                  <button
                    type="submit"
                    className="bg-brand-700 border-brand-700 w-full rounded border p-3 text-white transition hover:bg-opacity-90"
                  >
                    Send Message
                  </button>
                </div>
